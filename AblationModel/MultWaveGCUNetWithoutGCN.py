...
import torch
from AstMad.net import WaveDecompose, IDWTLayers, EmbeddingGraph, MutiLevelWaveGCN
# from .net import NodeGraph


class MultWaveGCUNetWithoutGCN(nn.Module):
    """
        Discard GCN
    """
    def __init__(self, input_channel, embedding_dim=64, top_k=30, input_node_dim=2, graph_alpha=3, device=torch.device('cuda:1'), gc_depth=1, batch_size=128):
        super(MultWaveGCUNetWithoutGCN, self).__init__()
